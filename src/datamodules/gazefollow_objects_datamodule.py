...
from src.datamodules.components.GazeFollowObjects import GazeFollowObjects
from src.utils import misc


class GazeFollowObjectsDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = "data/",
        batch_size: int = 64,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.data_train = GazeFollowObjects(
        ...
        self.data_val = GazeFollowObjects(
            self.hparams.data_dir,
            self.transforms_val,
            is_train=False,
            num_queries=self.hparams.num_queries,
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(
        root / "configs" / "datamodule" / "gazefollow_objects.yaml"
    )
